...
//
//        // Retrieve the Blog by ID and set it on the Comment
//        Blog blog = blogService.getBlogByIdd(createCommentDTO.getBlogId());
//        comment.setBlog(blog);
//
//        // Retrieve the User by ID and set it on the Comment
//        User user = userDetailsService.getUserById(createCommentDTO.getUserId());
